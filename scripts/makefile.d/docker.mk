...
build/docker-image: Dockerfile $(MAKEFILE_LIST) | runtime/tools/$(DOCKER)
	@mkdir -p $(dir $@)
	$(DOCKER) build \
...
build/docker-image.pushed: build/docker-image | runtime/tools/docker
	@mkdir -p $(dir $@)
