...
# eg.
# $(CERT_DIR)/local/server.crt: OPTIONAL_SAN=",DNS:example.com,DNS:example.localhost,IP:127.0.0.1"
...
$(CERT_DIR)/local/app/server.crt:  OPTIONAL_SAN=",IP:127.0.0.1"

$(CERT_DIR)/local/etcd/server.crt: OPTIONAL_SAN=",IP:127.0.0.1"
